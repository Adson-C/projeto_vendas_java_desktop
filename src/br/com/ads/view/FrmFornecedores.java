...
public class FrmFornecedores extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(255, 220, 123));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(10, 1, 40));
        ...
        btnPesquisarNome.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                btnPesquisarNomeKeyPressed(evt);
            }
        });
        ...
        tabelaClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CNPJ", "E-mail", "Telefone", "Celular", "CEP", "Endereço", "Numero", "Compl", "Bairro", "Cidade", "UF"
            }
        ));
        ...
        tabbeDados.addTab("Consulta de Fornecedores", painelPesquisa);
    ...
    private void tabelaClientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaClientesMouseClicked
        ...
        txtCel.setText(tabelaClientes.getValueAt(tabelaClientes.getSelectedRow(), 5).toString());
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        // Exluir
            ...
            String msg = "Deseja Deletar o Fornecedor ?";
        ...
        if(opcaoEscolhida == JOptionPane.YES_OPTION) {
            ...
            JOptionPane.showMessageDialog(null, "O Fornecedor "  + obj.getId()+
    ...
    private void btnPesquisarNomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_btnPesquisarNomeKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_btnPesquisarNomeKeyPressed
